<?php
/**
 * \file            detect-mobile-browsers.php
 * \brief           returns a boolean to detect browser type
 * \since           01 Oct 2013
 * \details         Borrowed and  adapted from http://detectmobilebrowsers.com/
 *
 * \todo            Change this into a function that is stored with in `inc/util/helper_functions.php`
 */
if(     preg_match(
            '/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop'
                ...
                . '|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone'
                . '|wap|windows (ce|phone)|xda|xiino/i'     ,
    ...
    ||  preg_match(
            '/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)'
                ...
                . '|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400'
